 ...
 */
TEST_F(BLEZInstructionBDDTest, DISABLED_PositiveValueNoBranch) {
    // Given: 暫存器包含正數值
 ...
 */
TEST_F(BLEZInstructionBDDTest, DISABLED_ZeroValueBranch) {
    // Given: 暫存器包含零
 ...
 */
TEST_F(BLEZInstructionBDDTest, DISABLED_NegativeValueBranch) {
    // Given: 暫存器包含負數
 ...
 * Then  branch should occur
 */
TEST_F(BLEZInstructionBDDTest, DISABLED_MinIntValueBranch) {
    // Given: 暫存器包含最小負數
