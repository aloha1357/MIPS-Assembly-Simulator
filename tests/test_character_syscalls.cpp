...
TEST_F(CharacterSyscallTest, Given_PrintCharSyscall_When_ExecutedWithLargeValue_Then_OnlyLower8BitsUsed)
{
...
TEST_F(CharacterSyscallTest, Given_ReadCharSyscall_When_ExecutedWithMultipleChars_Then_FirstCharReturned)
{
