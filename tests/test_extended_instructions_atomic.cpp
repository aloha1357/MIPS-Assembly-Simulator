 ...
 * 
 * This test suite is specifically designed for testing newly implemented extended MIPS instructions: SLT, SLTI, BNE, BGTZ etc.
 * Each test is atomic, focusing on testing a single functionality point
 * 
...
/**
 * @brief Atomic test A.2: SLTI instruction basic functionality - positive number vs immediate (reverse)
 * 
